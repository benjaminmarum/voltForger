...
from database_service import DatabaseService  # This is the custom class that encapsulates the database operations
...
class ServiceManager:
    ...
    def __init__(self):
        ...
        self.parser = argparse.ArgumentParser()  # Initialize a new ArgumentParser object
    ...
    def setup_argparse(self):
        ...
        self.parser.add_argument('--init-app', action='store_true')  # If --init-app is passed in the command line, set the 'init_app' attribute to True
        self.parser.add_argument('--init-db', action='store_true')  # If --init-db is passed in the command line, set the 'init_db' attribute to True
        self.parser.add_argument('--run-app', action='store_true')  # If --run-app is passed in the command line, set the 'run_app' attribute to True
        self.parser.add_argument('--create-migration', type=str)  # If --create-migration is passed in the command line, set the 'create_migration' attribute to the string passed with the command
        self.parser.add_argument('--upgrade-db', action='store_true')  # If --upgrade-db is passed in the command line, set the 'upgrade_db' attribute to True
